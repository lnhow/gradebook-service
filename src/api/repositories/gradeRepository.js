...
class gradeRepository extends BaseRepository {
    ...
    /** 
     * Return id is assignment_id, NOT the grade_id
     */
    showGradeByCodeAndId(student_code,assignment_id)
    {
        let sql = 
        `SELECT t.id,t1.id as grade_id,t.title,t.weight,t.finalized,t1.grade,t1.created_at,t1.updated_at 
        FROM tbl_assignment t JOIN ${this.table} t1 ON t1.assignment_id=t.id
